...
<p><?php
$result2=mysql_query("SELECT * FROM `$table_cards` WHERE `category`='$type' AND `worth`='1'") or die("Unable to select from database.");
$min=1;
...
echo "<br /><strong>$game ($category[$type]):</strong> $rewards</p><p><a href=\"/interactive.php\">&larr; back to the games?</a></p>";
include("$footer"); ?>