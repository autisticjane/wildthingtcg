...
ob_end_clean();
$buffer=str_replace("%TITLE%","Group Collect | Wild Thing",$buffer);
echo $buffer;
...
if(!$_SERVER['QUERY_STRING']) {
	...
	while($row=mysql_fetch_assoc($select)) {
		?>
		<h1>Group Collect</h1>
		<p>Work with your fellow members to complete the deck!</p>
		<ul><li>You may submit <strong>2</strong> cards per week. Each week begins on Sunday.</li>
		<li>You may keep the card(s) you submit.</li></ul>

		<form method="post" action="game_collect.php?add">
